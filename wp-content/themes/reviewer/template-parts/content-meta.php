...
if ( function_exists( 'rwmb_meta' ) && isset(rwmb_meta( 'product-rating' )[0] )) { ?>
	<li class="custom-meta-item">
		<span class="custom-meta-label"><?php _e('Product Rating','reviewer'); ?></span><span class="custom-meta-value"><?php echo esc_html( rwmb_meta ( 'product-rating' )[0] ); ?></span>
	</li><!-- .custom-meta-item -->
	<?php 
}
...
if ( function_exists( 'rwmb_meta' ) && isset(rwmb_meta( 'product-price' )[0]) ) { ?>
	<li class="custom-meta-item">
		<span class="custom-meta-label"><?php _e('Product Price','reviewer'); ?></span><span class="custom-meta-value"><?php echo esc_html( rwmb_meta( 'product-price' )[0] ); ?></span>
	</li><!-- .custom-meta-item -->
	<?php 
}